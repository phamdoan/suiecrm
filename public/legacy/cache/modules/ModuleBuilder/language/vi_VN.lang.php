...
$mod_strings = array (
  ...
  array (
    ...
    array (
      ...
      'sugarPortalBtn' => 'Sử dụng Trình chỉnh sửa cổng thông tin SuiteCRM để quản lý và tùy <b>chỉnh Cổng thông tin SuiteCRM</b>.',
      ...
      'portalLayoutHelp' => 'Các mô-đun trong Cổng thông tin SuiteCRM xuất hiện trong khu vực này. <br><br>Chọn một mô-đun để chỉnh sửa <b>Bố cục</b>.',
...
<b>Xóa:</b> Xóa mô-đun này khỏi bố cục chuyển đổi. <br/><br/>',
  ...
  'LBL_POPHELP_IMPORTABLE' => '<b>Có</b>: Trường này sẽ được bao gồm trong thao tác nhập.<br><b>Không</b>: Trường này sẽ không được bao gồm trong quá trình nhập. <br><b>Bắt buộc</b>: Một giá trị cho trường phải được cung cấp trong bất kỳ lần nhập nào.',
  'LBL_POPHELP_IMAGE_WIDTH' => 'Nhập một số cho Chiều rộng, như được đo bằng pixel. <br> Hình ảnh được tải lên sẽ được chia tỷ lệ theo Chiều rộng này.',
  'LBL_POPHELP_IMAGE_HEIGHT' => 'Nhập một số cho Chiều cao, như được đo bằng pixel. <br> Hình ảnh được tải lên sẽ được chia tỷ lệ thành Chiều cao này.',
  'LBL_POPHELP_DUPLICATE_MERGE' => 'b> Đã bật </b>: Trường sẽ xuất hiện trong tính năng Hợp nhất các bản sao, nhưng sẽ không có sẵn để sử dụng cho các điều kiện lọc trong tính năng Tìm bản sao. <br> <b> Đã tắt </b>: Trường sẽ không xuất hiện trong tính năng Hợp nhất các bản sao và sẽ không có sẵn để sử dụng cho các điều kiện lọc trong tính năng Tìm bản sao. <br> <b> Bộ lọc </b>: Trường sẽ xuất hiện trong tính năng Hợp nhất các bản sao và sẽ có sẵn để sử dụng cho các điều kiện lọc trong tính năng Tìm bản sao. <br> <b> Bộ lọc được chọn mặc định </b>: Trường sẽ xuất hiện trong tính năng Hợp nhất các bản sao và sẽ được sử dụng theo mặc định cho các điều kiện lọc trong Tính năng Tìm bản sao. <br> <b> Chỉ bộ lọc </b>: Trường sẽ không xuất hiện trong tính năng Hợp nhất các bản sao, nhưng sẽ có sẵn để sử dụng cho các điều kiện lọc trong tính năng Tìm bản sao.',
  'LBL_RESET' => 'Reset',
  ...
  array (
    ...
    'phone' => 'Điện thoại',
    'currency' => 'Tiền tệ',
    'html' => 'Chỉ đọc HTML(không dùng nữa, dùng khối văn bản)',
    'radioenum' => 'Radio',
    'relate' => 'Liên quan',
    'address' => 'Địa chỉ',
