...
$mod_strings = array (
  ...
  'ERR_UW_UPLOAD_ERR' => 'Đã có lỗi trong khi tải lên các tập tin, xin vui lòng thử lại!<br>
',
  ...
  'LBL_UW_COMMIT_ADD_TASK_DESC_1' => 'Các sao lưu của các tệp bị ghi đè nằm trong thư mục sau: 
',
  'LBL_UW_COMMIT_ADD_TASK_DESC_2' => 'Hợp nhất các tệp sau đây theo cách thủ công: 
',
...
',
  ...
  'LBL_UW_START_DESC2' => 'Lưu ý: Chúng tôi đặc biệt khuyên bạn nên tạo một bản sao của phiên bản SuiteCRM bạn sử dụng trong sản xuất và kiểm tra gói nâng cấp trước khi triển khai phiên bản mới. Nếu bạn đã thay đổi tệp "composer.json", thì vui lòng, sau khi quá trình nâng cấp hoàn tất, hãy chạy lệnh này: <br/><br/><pre>composer install --no-dev</pre>',
  ...
  'LBL_RECOMMENDED_PHP_VERSION_2' => ' hoặc ở trên.',
  ...
  'LBL_MODULELOADER' => 'Bộ nạp mô-đun',
  'LBL_PATCHUPGRADES' => 'Nâng cấp bản vá lỗi',
  'LBL_THEMES' => 'Chủ đề',
