...
/* Smarty version 4.5.3, created on 2025-07-31 16:11:28
  from 'C:\xampp\htdocs\suitecrm\public\legacy\ModuleInstall\PackageManager\tpls\PackageManagerScripts.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_688b79906e6362_04296180',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a53bf4f1881d5b383b89daf3f7b6341055b3d639' => 
    array (
      0 => 'C:\\xampp\\htdocs\\suitecrm\\public\\legacy\\ModuleInstall\\PackageManager\\tpls\\PackageManagerScripts.tpl',
      1 => 1738223968,
      2 => 'file',
    ),
  ),
...
function content_688b79906e6362_04296180 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\suitecrm\\public\\legacy\\include\\Smarty\\plugins\\function.sugar_getscript.php','function'=>'smarty_function_sugar_getscript',),));
		...
		*/
	    ...
	    return {
	        ...
	        initPMG: function(){
	        	...
	        	<?php } elseif ($_smarty_tpl->tpl_vars['IS_ALIVE']->value == 'true') {?>
	        									_loadingBar =
					...
					_loadingBar.setHeader("<?php echo $_smarty_tpl->tpl_vars['MOD']->value['SEARCHING_UPDATES'];?>
");
	        ...
	        download : function(){
	        	if(confirm('<?php echo $_smarty_tpl->tpl_vars['MOD']->value['DOWNLOAD_QUESTION'];?>
')){
					...
					_loadingBar.setHeader("<?php echo $_smarty_tpl->tpl_vars['MOD']->value['DOWNLOADING'];?>
");
					_loadingBar.setBody("<img src=\"include/javascript/yui/assets/rel_interstitial_loading.gif\"/>");
					_loadingBar.render(document.body);
					_loadingBar.show();
	        			...
	        			_loadingBar.setHeader("<?php echo $_smarty_tpl->tpl_vars['MOD']->value['DL_PACKAGES_DOWNLOADING'];?>
 "+_numPackagesToDownload+" <?php echo $_smarty_tpl->tpl_vars['MOD']->value['DL_PACKAGES_PACKAGES'];?>
");
	        ...
	        PackageManager.hideWaiting();
	        	...
	        	if(typeof result != 'undefined') {
					...
					_loadingBar.setHeader("<?php echo $_smarty_tpl->tpl_vars['MOD']->value['DL_PACKAGES_DOWNLOADING'];?>
 "+_numDownloadsComplete+" <?php echo $_smarty_tpl->tpl_vars['MOD']->value['DL_PACKAGES_OF'];?>
 "+_numPackagesToDownload+ " <?php echo $_smarty_tpl->tpl_vars['MOD']->value['DL_PACKAGES_PACKAGES'];?>
");
	        		if(_numPackagesToDownload == _numDownloadsComplete){
						_loadingBar.hide();
	        			if(!<?php echo $_smarty_tpl->tpl_vars['INSTALLATION']->value;?>
){
	        ...
	        buildListView : function(result, showDownloadButton){
		        ...
		        display += "<tr><th align=left class='listViewThLinkS1'><?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_ML_NAME'];?>
</th><th align=left class='listViewThLinkS1'><?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_ML_TYPE'];?>
</th><th align=left class='listViewThLinkS1'><?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_ML_VERSION'];?>
</th><th align=left class='listViewThLinkS1'><?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_ML_PUBLISHED'];?>
</th><th class='listViewThLinkS1'><?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_ML_DESCRIPTION'];?>
</th><th class='listViewThLinkS1'><?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_ML_ACTION'];?>
</th></tr>";
		        for (var x = 0; x < result['packages'].length; x++)
	   			{
                	...
                	if((x % 2) == 0){
	   				...
	   				if(showDownloadButton){
                		install_link += "<input type=submit class='button' name=\"btn_mode\" onclick=\"this.form.mode.value='Install';this.form.package_id.value="+result['packages'][x]['id']+";this.form.submit();\" value=\"<?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_UW_BTN_DOWNLOAD'];?>
\" />";
                	}
	        ...
	        toggleLowerDiv: function(outer_div, animate_div){
                ...
                var show_img = '<?php echo $_smarty_tpl->tpl_vars['SHOW_IMG']->value;?>
';
                var hide_img = '<?php echo $_smarty_tpl->tpl_vars['HIDE_IMG']->value;?>
';
	        				...
	        				if(typeof result != 'undefined') {
								...
								for (var x = 0; x < result['updates'].length; x++){
									...
									if(result['updates'][x]['type'] == 'patch'){
										tmpNodeRelease.onCheckClick = function(){this.uncheck();if(confirm('<?php echo $_smarty_tpl->tpl_vars['MOD']->value['MI_REDIRECT_TO_UPGRADE_WIZARD'];?>
')){location.href = '<?php echo $_smarty_tpl->tpl_vars['UPGARDE_WIZARD_URL']->value;?>
'}};
									}else{
										tmpNodeRelease.onCheckClick = function(){this.data['isSelected'] = this.checked;};
									}
			...
			refreshTreeRoot : function(){
				PackageManager.showWaiting();
				_loadingBar.setHeader("<?php echo $_smarty_tpl->tpl_vars['MOD']->value['LOADING_CATEGORIES'];?>
");
 				var callback =	{
		  			success: function(data) {
						_loadingBar.hide();
			...
			refreshGrid : function(){
				PackageManager.showWaiting();
				_loadingBar.setHeader("<?php echo $_smarty_tpl->tpl_vars['MOD']->value['SEARCHING_PACKAGES'];?>
");
 				var callback =	{
		  			success: function(data) {
		  			_loadingBar.hide();
				...
				var types = "<?php echo $_smarty_tpl->tpl_vars['GRID_TYPE']->value;?>
";
			...
			initTabs : function(){
				...
				var detailTab = _tabs.addTab('details', "<?php echo $_smarty_tpl->tpl_vars['MOD']->value['ML_LBL_DETAIILS'];?>
");
				detailTab.setContent('<?php echo $_smarty_tpl->tpl_vars['MOD']->value['ML_DESC_DOCUMENTATION'];?>
', false);
        		_tabs.addTab('documentation', "<?php echo $_smarty_tpl->tpl_vars['MOD']->value['ML_LBL_DOCUMENTATION'];?>
");
        		_tabs.addTab('screenshots', "<?php echo $_smarty_tpl->tpl_vars['MOD']->value['ML_LBL_SCREENSHOTS'];?>
");
        		_tabs.addTab('reviews', "<?php echo $_smarty_tpl->tpl_vars['MOD']->value['ML_LBL_REVIEWS'];?>
");
        		_tabs.activate('details');*/
			},
			remove : function(file){
				if(confirm('<?php echo $_smarty_tpl->tpl_vars['MOD']->value['REMOVE_QUESTION'];?>
')){
				//PackageManager.showWaiting();
				var callback =	{
		  			success: function(data) {
			...
			//rrs
					...
					_loadingBar.setHeader("<?php echo $_smarty_tpl->tpl_vars['MOD']->value['AUTHENTICATING'];?>
");
					_loadingBar.setBody("<img src=\"include/javascript/yui/assets/rel_interstitial_loading.gif\"/>");
					_loadingBar.render(document.body);
					_loadingBar.show();
...
<?php echo $_smarty_tpl->tpl_vars['PATCHES']->value;?>

<?php echo $_smarty_tpl->tpl_vars['INSTALLED_MODULES']->value;?>
...
<?php if ($_smarty_tpl->tpl_vars['module_load']->value == 'true') {?>
		...
		_fileGrid = new YAHOO.widget.ScrollingDataTable(
                'patch_downloads',
                [
					{key:'name', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Name'];?>
', minWidth: Math.round(patch_downloads_minWidth*1.5), sortable: true, resizeable: true},
                    {key:'file', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Install'];?>
', minWidth: Math.round(patch_downloads_minWidth/1.5), formatter: this.renderInstallButton, resizeable: true},
                    {key:'unFile', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Delete'];?>
', minWidth: Math.round(patch_downloads_minWidth), formatter: this.renderDeleteButton, resizeable: true},
        		    {key:'type', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Type'];?>
', minWidth: Math.round(patch_downloads_minWidth/1.5)},
        		    {key:'version', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Version'];?>
', minWidth: Math.round(patch_downloads_minWidth)},
        		    {key:'date', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Published'];?>
', minWidth: Math.round(patch_downloads_minWidth)},
        	 	    {key:'uninstallable',  label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Uninstallable'];?>
', minWidth: Math.round(patch_downloads_minWidth/1.5)},
        		    {key:'description',label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Description'];?>
', minWidth: Math.round(patch_downloads_minWidth*1.5), sortable: true}
        		],
	    ...
	    _fileGridInstalled = new YAHOO.widget.ScrollingDataTable('installed_grid',
            [
			    {key:'name', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Name'];?>
', sortable: true, 'minWidth' : Math.round(minWidth*1.5)},
                {key:'unFile', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Action'];?>
', formatter: this.renderUninstallButton, 'minWidth' : Math.round(minWidth/1.5)},
                {key:'state_file', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Enable_Or_Disable'];?>
',formatter: this.renderEnableDisableButton, 'minWidth' : Math.round(minWidth/1.5)},
      		    {key:'type', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Type'];?>
', 'minWidth' : Math.round(minWidth/1.5)},
      		    {key:'version', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Version'];?>
', 'minWidth' : Math.round(minWidth)},
      		    {key:'date', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Date_Installed'];?>
', 'minWidth' : Math.round(minWidth)},
      		    {key:'description', label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Description'];?>
', sortable: true, 'minWidth' : Math.round(minWidth*1.5)}
      		],
...
<?php } else { ?>
  		_fileGrid = new YAHOO.ext.grid.DDGrid(
                ...
                new YAHOO.ext.grid.DefaultColumnModel([
					{label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Description'];?>
', width: 215},
        		    {label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Version'];?>
', width: 72},
        		    {label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Build'];?>
', width: 80, sortable: true, sortType: sort.asUCString},
        		    {label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Action'];?>
', width: 90, renderer: this.renderButtons}
        		])
            );
  	    _fileGrid.autoSizeColumns = true;
    	_fileGrid.autoSizeHeaders = true;
	<?php }?>
	PackageManager.showStatusMessages('<?php echo $_smarty_tpl->tpl_vars['ML_STATUS_MESSAGE']->value;?>
');
}
...
PackageManagerGrid.prototype.renderModuleButtons = function(file){
	var output =  '<table border=0 cellpadding=0 cellspacing=0><tr><td><form action="index.php?module=Administration&view=module&action=UpgradeWizard_prepare" method="post">';
    	output += '<input type=submit class=\'button\' name="btn_mode" onclick="this.form.mode.value=\'Install\';this.form.submit();" value="<?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_UW_BTN_INSTALL'];?>
" />';
        ...
        output += '<input type=submit class=\'button\' name="run" value="<?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_UW_BTN_DELETE_PACKAGE'];?>
" />';
        output += '<input type=hidden name="install_file" value="'+file+'" />';
...
PackageManagerGrid.prototype.renderUninstallButton = function(elCell, oRecord, col, data) {
	...
	if(file.indexOf('errors_') == 0){
		...
		var output =  '<span style="text-align:center;"><form action="index.php?module=Administration&view=module&action=UpgradeWizard_prepare" method="post">';
    	output += '<input type=submit class=\'button\' name="btn_mode" onclick="this.form.mode.value=\'Uninstall\';this.form.submit();" value="<?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_UW_UNINSTALL'];?>
" />';
        output += '<input type=hidden name="install_file" value="'+file+'" />';
		output += '<input type=hidden name="mode"/>';
        output += '</form></span>';
...
PackageManagerGrid.prototype.renderEnableDisableButton = function(elCell, oRecord, col, data) {
	...
	if(state_file.indexOf('ENABLED_') == 0){
		...
		output += '<input type=submit class=\'button\' name="btn_mode" onclick="this.form.mode.value=\'Disable\';this.form.submit();" value="<?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_UW_DISABLE'];?>
" />';
		 output += '<input type=hidden name="install_file" value="'+file+'" />';
		output += '<input type=hidden name="mode"/>';
    	output += '</form></span>';
    	...
    	output += '<input type=submit class=\'button\' name="btn_mode" onclick="this.form.mode.value=\'Enable\';this.form.submit();" value="<?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_UW_ENABLE'];?>
" />';
    	output += '<input type=hidden name="install_file" value="'+file+'" />';
		output += '<input type=hidden name="mode"/>';
    	output += '</form></span>';
...
var output = "<span style='text-align:center;'><input type='button' class='button' value='<?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_UW_BTN_DELETE_PACKAGE'];?>
' onClick='PackageManager.remove(\""+file+"\");'></span>";
...
PackageManagerGrid.prototype.renderButtons = function(packageID){
	var output = "<input type='button' value='Download' class='button' onClick=\"<?php if ($_smarty_tpl->tpl_vars['INSTALLATION']->value != 0) {?>this.form.run.value='upload';<?php }?>this.form.release_id.value='"+packageID+"';this.form.submit();\">";
    return output;
}
